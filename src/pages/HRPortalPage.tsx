...
const DifferentiatorCard = ({ title, description, idx }: { title: string; description: string; idx: number }) => (
  ...
  >
    <SectionIcon icon={CheckCircle2} size="md" className="mb-6" hover="none" />
...
export const HRPortalPage = () => {
  ...
  return (
    <PageShell bare>
            <PageHero
        title="HR Portal Accelerator"
        tagline="Building a high-performance home for your most valuable asset: People."
        description="A unified, high-performance portal for employee self-service, leave management, and company culture engineered for enterprise scale."
      />
