  ...
  const whatWeSolve = [
    {
      ...
      description:
        "Real-time visibility into sales performance, targets, and gap analysis.",
      imageUrl: "Images/23498.jpg",
    },
    {
      title: "Distribution Tracking",
      description:
        "Track inventory, secondary sales, and distributor performance.",
      imageUrl: "Images/2151680571.jpg",
    },
    {
      title: "Trade Promotion Optimization",
      description: "Measure ROI on promotions and optimize spend allocation.",
      imageUrl: "Images/2152005500.jpg",
    },
    {
      title: "Territory Management",
      description: "Data-driven territory design and field force optimization.",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            >
              ...
              <br />
              <span className="text-slate-400">Data-Driven Solutions.</span>
            </motion.h2>
          </div>
