...
export const HSEAnalyticsPage = () => {
  ...
  return (
    <PageShell bare>
            <PageHero
        title="HSE Analytics Suite"
        tagline="Protecting Assets. Empowering People."
        description="Bridge the safety gap with real-time incident tracking, automated compliance sensing, and predictive hazard intelligence for industrial scale."
      />
