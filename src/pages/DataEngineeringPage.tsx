...
export const DataEngineeringPage = () => {
  ...
  return (
    <PageShell bare>
        ...
        tagline="Build a Foundation for Scalable, Trusted, and Intelligent Data"
        description="Modern cloud-native data platforms, engineered for analytics, AI, and enterprise scale"
        imageSrc={DE_HERO_IMG}
      />
