  ...
  const whatWeSolve = [
    {
      title: "OEE Tracking",
      description:
        "Real-time Overall Equipment Effectiveness monitoring across all lines.",
      imageUrl: "Images/2988.jpg",
    },
    {
      title: "Production Analytics",
      description: "Track production targets, cycle times, and output quality.",
    ...
    },
    {
      ...
      description: "Defect tracking, SPC dashboards, and quality KPIs.",
